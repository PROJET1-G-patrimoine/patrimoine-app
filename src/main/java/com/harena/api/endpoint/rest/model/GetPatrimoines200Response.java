 ...
 */
@JsonPropertyOrder({
  GetPatrimoines200Response.JSON_PROPERTY_DATA
})
...
public class GetPatrimoines200Response implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_DATA = "data";
  private List<Patrimoine> data = new ArrayList<>();
  ...
  /**
   * Return true if this getPatrimoines_200_response object is equal to o.
   */
  @Override
